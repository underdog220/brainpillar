...
[2026-03-25] [Phase 11] Backend-Integration: BackendClient-Interface (health/export/sync/upload/evaluate), BackendModels (Request/Response fuer alle Endpunkte), StubBackendClient (deterministische Stub-Antworten mit failNext*-Steuerung), EffectDispatcher (mappt SimulatorEffects auf Backend-Aufrufe), DispatchResult sealed interface. BackendConfig-Modell. 12 neue Unit-Tests fuer Dispatcher und StubClient
